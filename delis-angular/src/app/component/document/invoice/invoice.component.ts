...
export class InvoiceComponent implements OnInit {
  ...
  @ViewChild('inputGroupStatusReason', {static: true}) inputGroupStatusReason: ElementRef;
  @ViewChild('inputGroupEffectiveDate', {static: true}) inputGroupEffectiveDate: ElementRef;
  @ViewChild('inputGroupStatusAction', {static: true}) inputGroupStatusAction: ElementRef;
  @ViewChild('inputGroupStatusAction2', {static: true}) inputGroupStatusAction2: ElementRef;
