...
import { DATE_FORMAT, FIRST_DAY } from '../../../app.constants';
...
export class DaterangeComponent implements OnInit {
  ...
  @Input() drops: string;
  @Input() opens: string;
  @Input() dateRangeModel: DateRangePickerModel;
  ...
  constructor(
    ...
    this.forwardingLanguageObservable.listen().subscribe((lang: string) => {
      this.lang = lang;
  ...
  change() {
    if (this.dateRange !== undefined && this.isCanInit) {
      ...
      this.daterangeObservable.loadDate(this.dateRangeModel);
    }
  }
