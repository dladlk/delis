...
export class DocumentsErrorComponent implements OnInit {
    ...
    currentState: StateDocumentsErrorModel;
    ...
    protected initProcess() {
        ...
        this.currentProdDocuments(this.pagination.currentPage, this.pagination.pageSize, this.errorsFlag);
    }

    protected initDefaultValues() {
        this.currentState = this.stateService.getFilterDocumentErrorState();
    ...
    protected currentProdDocuments(currentPage: number, sizeElement: number, errorsFlag: boolean) {
        this.documentsService.getErrorListDocuments(currentPage, sizeElement, this.filter, errorsFlag).subscribe(
            (data: {}) => {
                ...
                this.stateService.setFilterDocumentErrorState(this.currentState);
            }, error => {
    ...
    protected clearAllFilter() {
        this.stateService.clearFilterDocumentSErrorState();
    }
}
