...
const routes: Routes = [
    {
        ...
        children: [
            ...
            { path: 'journal-documents', loadChildren: './journal/document/modules/journal.document.module#JournalDocumentModule' },
            { path: 'journal-organisations', loadChildren: './journal/organisation/modules/journal.organisation.module#JournalOrganisationModule' },
            { path: 'journal-identifiers', loadChildren: './journal/identifier/modules/journal.identifier.module#JournalIdentifierModule' },
