...
mkdir ./docker/app/delis  && mv ./docker/app/BOOT-INF/lib/delis-*.jar ./docker/app/delis
mkdir ./docker/app/oxalis && mv ./docker/app/BOOT-INF/lib/Oxalis-*.jar ./docker/app/oxalis
