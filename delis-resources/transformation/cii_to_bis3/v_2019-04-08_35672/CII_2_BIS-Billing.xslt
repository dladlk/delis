...
******************************************************************************************************************
        ...
        File version:       $Revision: 35519 $
        Last changed by:    $Author: skovhus $
        Last changed date:  $Date: 2019-01-10 13:27:47 +0100 (to, 10 jan. 2019) $
		...
		For more information, see www.digst.dk
...
-->
	...
	<xsl:template name="EndpointIDSchemeIDmapping">
		...
		<cbc:EndpointID schemeID="{$GlobalIDScheme}">
