...
3.0 Release Notes
-----------------
This version include a number of correction (since version 1.7.0) in the transformation from Peppol BIS Billing to OIOUBL.

  NH-913: Peppol Code List 7.5 has introduced FI:ORGNR, which is added to the transaction from Peppol BIS Billing to OIOUBL, as FI:ORGNR is allowed in OIOUBL.
  NH-1013: Correction - PaymentMeans = 42 with different on PayeeFinancialAccount\ID.
  NH-1072: Correction - Parrt sub-element Person was not support in stylesheet. 
  NH-1074: Correction - AccountingCustomerParty/cac:PartyTaxScheme with blanck CompanyID.
...
2021.11.15  Version 1.8.0 mandatory.
