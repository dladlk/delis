...
<xsl:stylesheet xmlns:cac="urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2"
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="/*" priority="1009" mode="M16">
   ...
   <!--RULE -->
   <xsl:template match="/ubl:ApplicationResponse" priority="1059" mode="M17">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
   ...
   <!--RULE -->
   <xsl:template match="/ubl:ApplicationResponse/cbc:ID" priority="1056" mode="M17">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
   ...
   <!--RULE -->
   <xsl:template match="/ubl:ApplicationResponse/*" priority="1000" mode="M17">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="/ubl:ApplicationResponse/*"/>
      <!--ASSERT -->
      <xsl:choose>
   ...
   <!--RULE -->
   <xsl:template match="cbc:CustomizationID" priority="1001" mode="M18">
