...
<xsl:stylesheet xmlns:cac="urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2"
   ...
   <!--RULE -->
   <xsl:template match="/ubl:ApplicationResponse" priority="1034" mode="M18">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
   ...
   <!--RULE -->
   <xsl:template match="/ubl:ApplicationResponse/cbc:ID" priority="1031" mode="M18">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="cbc:CustomizationID" priority="1000" mode="M19">
