...
<xsl:stylesheet xmlns:xs="http://www.w3.org/2001/XMLSchema"
   ...
   <xsl:template match="ubl-invoice:Invoice/cac:AllowanceCharge | ubl-invoice:Invoice/cac:InvoiceLine/cac:AllowanceCharge | ubl-creditnote:CreditNote/cac:AllowanceCharge | ubl-creditnote:CreditNote/cac:CreditNoteLine/cac:AllowanceCharge"
	  ...
	  <!--RULE -->
   <xsl:template match="cbc:TaxExemptionReasonCode" priority="1008" mode="M12">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
   ...
   <xsl:template match="cbc:Amount | cbc:BaseAmount | cbc:PriceAmount | cac:TaxTotal[cac:TaxSubtotal]/cbc:TaxAmount | cbc:TaxableAmount | cbc:LineExtensionAmount | cbc:TaxExclusiveAmount | cbc:TaxInclusiveAmount | cbc:AllowanceTotalAmount | cbc:ChargeTotalAmount | cbc:PrepaidAmount | cbc:PayableRoundingAmount | cbc:PayableAmount"
	  ...
	  <!--RULE -->
   <xsl:template match="cac:TaxTotal[not(cac:TaxSubtotal)]/cbc:TaxAmount"
                 priority="1005"
                 mode="M12">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="cac:TaxTotal[not(cac:TaxSubtotal)]/cbc:TaxAmount"/>
   ...
   <xsl:template match="ubl-creditnote:CreditNote | ubl-invoice:Invoice"
      ...
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
		    ...
		    <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="not(cac:AccountingSupplierParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode = 'DK'                         and (normalize-space(cbc:AccountingCost/text()) = ''))"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not(cac:AccountingSupplierParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode = 'DK' and (normalize-space(cbc:AccountingCost/text()) = ''))">
		    ...
		    <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="not(cac:AccountingSupplierParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode = 'DK'                         and (normalize-space(./cac:AccountingSupplierParty/cac:Party/cac:PartyLegalEntity/cbc:CompanyID/text()) = ''))"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not(cac:AccountingSupplierParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode = 'DK' and (normalize-space(./cac:AccountingSupplierParty/cac:Party/cac:PartyLegalEntity/cbc:CompanyID/text()) = ''))">
   ...
   <xsl:template match="ubl-creditnote:CreditNote/cac:CreditNoteLine | ubl-invoice:Invoice/cac:InvoiceLine"
      ...
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
		    ...
		    <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="not(../cac:AccountingSupplierParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode = 'DK'                         and cac:Item/cac:CommodityClassification/cbc:ItemClassificationCode/@listID='MP'                         and not(cac:Item/cac:CommodityClassification/cbc:ItemClassificationCode/@listVersionID = '19.05.01'                                or cac:Item/cac:CommodityClassification/cbc:ItemClassificationCode/@listVersionID = '19.0501'                             )                         )"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not(../cac:AccountingSupplierParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode = 'DK' and cac:Item/cac:CommodityClassification/cbc:ItemClassificationCode/@listID='MP' and not(cac:Item/cac:CommodityClassification/cbc:ItemClassificationCode/@listVersionID = '19.05.01' or cac:Item/cac:CommodityClassification/cbc:ItemClassificationCode/@listVersionID = '19.0501' ) )">
	  ...
	  <!--RULE -->
   <xsl:template match="cac:AllowanceCharge" priority="1000" mode="M13">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="cac:AllowanceCharge"/>

		    <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="not(//cac:AccountingSupplierParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode = 'DK'                   and cbc:AllowanceChargeReasonCode = 'ZZZ'                   and not(string-length(normalize-space(cbc:AllowanceChargeReason/text())) = 4                           and number(cbc:AllowanceChargeReason) &gt;= 0                           and number(cbc:AllowanceChargeReason) &lt;= 9999)                  )"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not(//cac:AccountingSupplierParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode = 'DK' and cbc:AllowanceChargeReasonCode = 'ZZZ' and not(string-length(normalize-space(cbc:AllowanceChargeReason/text())) = 4 and number(cbc:AllowanceChargeReason) &gt;= 0 and number(cbc:AllowanceChargeReason) &lt;= 9999) )">
   ...
   <xsl:template match="cac:AllowanceCharge[cbc:ChargeIndicator='true']/cbc:AllowanceChargeReasonCode"
	  ...
	  <!--RULE -->
   <xsl:template match="cac:ClassifiedTaxCategory/cbc:ID | cac:TaxCategory/cbc:ID"
                 priority="1006"
                 mode="M14">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="cac:ClassifiedTaxCategory/cbc:ID | cac:TaxCategory/cbc:ID"/>
   ...
   <xsl:template match="cbc:Amount | cbc:BaseAmount | cbc:PriceAmount | cbc:TaxAmount | cbc:TaxableAmount | cbc:LineExtensionAmount | cbc:TaxExclusiveAmount | cbc:TaxInclusiveAmount | cbc:AllowanceTotalAmount | cbc:ChargeTotalAmount | cbc:PrepaidAmount | cbc:PayableRoundingAmount | cbc:PayableAmount"
	  ...
	  <!--RULE -->
   <xsl:template match="cbc:InvoiceTypeCode" priority="1002" mode="M14">
	  ...
	  <!--RULE -->
   <xsl:template match="cbc:CreditNoteTypeCode" priority="1001" mode="M14">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
