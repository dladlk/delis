...
<xsl:stylesheet xmlns:xs="http://www.w3.org/2001/XMLSchema"
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="cbc:*" priority="1001" mode="M12">
	  ...
	  <!--RULE -->
   <xsl:template match="cac:*" priority="1000" mode="M12">
   ...
   <xsl:template match="ubl-creditnote:CreditNote | ubl-invoice:Invoice"
	  ...
	  <!--RULE -->
   <xsl:template match="cbc:TaxCurrencyCode" priority="1012" mode="M13">
   ...
   <xsl:template match="ubl-creditnote:CreditNote | ubl-invoice:Invoice"
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not(($supplierCountry = 'DK') and (normalize-space(cbc:AccountingCost/text()) = '') )">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not(($supplierCountry = 'DK') and not(normalize-space(cac:AccountingSupplierParty/cac:Party/cac:PartyLegalEntity/cbc:CompanyID/text()) != '') )">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not(($supplierCountry = 'DK') and (((boolean(cac:AccountingSupplierParty/cac:Party/cac:PartyIdentification/cbc:ID)) and (normalize-space(cac:AccountingSupplierParty/cac:Party/cac:PartyIdentification/cbc:ID/@schemeID) = '')) or ((boolean(cac:AccountingCustomerParty/cac:Party/cac:PartyIdentification/cbc:ID)) and (normalize-space(cac:AccountingCustomerParty/cac:Party/cac:PartyIdentification/cbc:ID/@schemeID) = '')) ) )">
	  ...
	  <!--RULE -->
   <xsl:template match="ubl-creditnote:CreditNote/cac:CreditNoteLine | ubl-invoice:Invoice/cac:InvoiceLine"
                 priority="1002"
                 mode="M15">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not(($supplierCountry = 'DK') and (cac:Item/cac:CommodityClassification/cbc:ItemClassificationCode/@listID = 'MP') and not((cac:Item/cac:CommodityClassification/cbc:ItemClassificationCode/@listVersionID = '19.05.01') or (cac:Item/cac:CommodityClassification/cbc:ItemClassificationCode/@listVersionID = '19.0501') ) )">
	  ...
	  <!--RULE -->
   <xsl:template match="cac:AllowanceCharge" priority="1001" mode="M15">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not(($supplierCountry = 'DK') and (cbc:AllowanceChargeReasonCode = 'ZZZ') and not((string-length(normalize-space(cbc:AllowanceChargeReason/text())) = 4) and (number(cbc:AllowanceChargeReason) &gt;= 0) and (number(cbc:AllowanceChargeReason) &lt;= 9999)) )">
	  ...
	  <!--RULE -->
   <xsl:template match="ubl-invoice:Invoice/cac:PaymentMeans"
                 priority="1000"
                 mode="M15">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not(($supplierCountry = 'DK') and not(contains(' 1 10 31 42 48 49 50 58 59 93 97 ', concat(' ', cbc:PaymentMeansCode, ' '))) )">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not(($supplierCountry = 'DK') and ((cbc:PaymentMeansCode = '31') or (cbc:PaymentMeansCode = '42')) and not((normalize-space(cac:PayeeFinancialAccount/cbc:ID/text()) != '') and (normalize-space(cac:PayeeFinancialAccount/cac:FinancialInstitutionBranch/cbc:ID/text()) != '')) )">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not(($supplierCountry = 'DK') and (cbc:PaymentMeansCode = '49') and not((normalize-space(cac:PaymentMandate/cbc:ID/text()) != '') and (normalize-space(cac:PaymentMandate/cac:PayerFinancialAccount/cbc:ID/text()) != '')) )">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not(($supplierCountry = 'DK') and (cbc:PaymentMeansCode = '50') and not(((substring(cbc:PaymentID, 0, 4) = '01#') or (substring(cbc:PaymentID, 0, 4) = '04#') or (substring(cbc:PaymentID, 0, 4) = '15#')) and (string-length(cac:PayeeFinancialAccount/cbc:ID/text()) = 7) ) )">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not(($supplierCountry = 'DK') and (cbc:PaymentMeansCode = '50') and ((substring(cbc:PaymentID, 0, 4) = '04#') or (substring(cbc:PaymentID, 0, 4) = '15#')) and not(string-length(cbc:PaymentID) = 19) )">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not(($supplierCountry = 'DK') and (cbc:PaymentMeansCode = '93') and not(((substring(cbc:PaymentID, 0, 4) = '71#') or (substring(cbc:PaymentID, 0, 4) = '73#') or (substring(cbc:PaymentID, 0, 4) = '75#')) and (string-length(cac:PayeeFinancialAccount/cbc:ID/text()) = 8) ) )">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not(($supplierCountry = 'DK') and (cbc:PaymentMeansCode = '93') and ((substring(cbc:PaymentID, 0, 4) = '71#') or (substring(cbc:PaymentID, 0, 4) = '75#')) and not((string-length(cbc:PaymentID) = 18) or (string-length(cbc:PaymentID) = 19)) )">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not(($supplierCountry = 'DK') and (cbc:PaymentMeansCode = '97') )">
   ...
   <xsl:template match="cbc:Amount | cbc:BaseAmount | cbc:PriceAmount | cbc:TaxAmount | cbc:TaxableAmount | cbc:LineExtensionAmount | cbc:TaxExclusiveAmount | cbc:TaxInclusiveAmount | cbc:AllowanceTotalAmount | cbc:ChargeTotalAmount | cbc:PrepaidAmount | cbc:PayableRoundingAmount | cbc:PayableAmount"
	  ...
	  <!--RULE -->
   <xsl:template match="cbc:InvoiceTypeCode" priority="1003" mode="M18">
	  ...
	  <!--RULE -->
   <xsl:template match="cbc:CreditNoteTypeCode" priority="1002" mode="M18">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
   ...
   <xsl:template match="cbc:IssueDate | cbc:DueDate | cbc:TaxPointDate | cbc:StartDate | cbc:EndDate | cbc:ActualDeliveryDate"
	  ...
	  <!--RULE -->
   <xsl:template match="cbc:EndpointID[@schemeID]" priority="1000" mode="M18">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
