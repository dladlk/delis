...
Current files are based on commit 2e68b6d (mandatory 15.05.2020) from https://github.com/OpenPEPPOL/peppol-bis-invoice-3/tree/master/rules/sch
Should there be any doubt about the CEN + PEPPOL XSLT files, the *.sch files are the common reference.


3.0 Release Notes
-----------------
Schematron XSLTs are based on PEPPOL BIS schematrons version 3.0.6 (see https://docs.peppol.eu/poacc/billing/3.0/release-notes/).
