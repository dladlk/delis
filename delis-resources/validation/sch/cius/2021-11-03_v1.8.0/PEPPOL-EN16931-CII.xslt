...
<xsl:stylesheet xmlns:iso="http://purl.oclc.org/dsdl/schematron"
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="rsm:ExchangedDocumentContext" priority="1024" mode="M21">
   ...
   <!--RULE -->
   <xsl:template match="rsm:ExchangedDocument" priority="1021" mode="M21">
   ...
   <!--RULE -->
   <xsl:template match="ram:BuyerTradeParty" priority="1020" mode="M21">
   ...
   <!--RULE -->
   <xsl:template match="ram:SellerTradeParty" priority="1019" mode="M21">
   ...
   <!--RULE -->
   <xsl:template match="ram:AppliedTradeAllowanceCharge" priority="1015" mode="M21">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
   ...
   <!--RULE -->
   <xsl:template match="ram:URIID[@schemeID = '9907']" priority="1002" mode="M21">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
   ...
   <!--RULE -->
   <xsl:template match="ram:URIID[@schemeID = '9906']" priority="1000" mode="M21">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
   ...
   <!--RULE -->
   <xsl:template match="ram:TaxTotalAmount[@currencyID]" priority="1003" mode="M27">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
   ...
   <!--RULE -->
   <xsl:template match="udt:DateTimeString" priority="1001" mode="M27">
