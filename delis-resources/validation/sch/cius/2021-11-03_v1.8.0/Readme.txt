...
3.0 Release Notes
-----------------
Schematron XSLTs are based on Peppol BIS schematrons version 3.0.10 (see https://docs.peppol.eu/poacc/billing/3.0/release-notes/).

PLEASE NOTE: 
- Saxon-HE version 10.3 is used as XSLT engine for test of schematrons.
- Validation output is NOT same as Danish OIOUBL schematron output.
...
2020.11.16  Version 1.6.2 mandatory (based on OpenPeppol version 3.0.9 - including hotfix from 2020-11-12)
