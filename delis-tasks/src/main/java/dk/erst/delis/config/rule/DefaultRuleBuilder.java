...
public class DefaultRuleBuilder {
    ...
    public static List<RuleDocumentValidation> buildDefaultValidationRuleList() {
        ...
        result.add(xsd(DocumentFormat.BIS3_CATALOGUE_WITHOUT_RESP, "xsd/UBL_2.1/maindoc/UBL-Catalogue-2.1.xsd"));
		...
		result.add(sch(DocumentFormat.BIS3_CATALOGUE_WITHOUT_RESP, peppol_bis3_other + "/PEPPOLBIS-T19.xslt", 10));
