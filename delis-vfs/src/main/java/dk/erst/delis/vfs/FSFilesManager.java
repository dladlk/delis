...
import dk.erst.delis.vfs.exception.FSSetUpException;
...
public class FSFilesManager {
    ...
    public FileObject setUpFileSystem(String url) throws FileSystemException {
        // Domain or default location
        String location = parseLocation(url);
        String authDomain = null;
        String user = parseUser(url);
        String password = parsePassword(url);
    ...
    private String parseUser(String url) {
        return null;
    }

    private String parseLocation(String url) {
        return null;
    }
