...
public class DocumentDelisWebApiServiceImpl implements DocumentDelisWebApiService {
    ...
    public Object generateInvoiceResponse(InvoiceResponseForm invoiceResponseForm) {
        ...
        try {
            ...
            String message = "Successfully sent generated " + invoiceResponseForm.getDocumentFormatName() + " with status " + sendDocument.getDocumentStatus();
            return new SuccessData(true, message);
