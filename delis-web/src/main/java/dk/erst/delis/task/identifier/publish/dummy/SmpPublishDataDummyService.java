...
public class SmpPublishDataDummyService {
	...
	private static String CERT_BASE64_STRING = "MIIEwjCCAqqgAwIBAgIEeUiPHTANBgkqhkiG9w0BAQsFADCBhjELMAkGA1UEBhMC" +
	...
	private SmpServiceEndpointData buildServiceEndpointData(String transportProfile, String url) {
		...
		byte[] certBytes = Base64.getDecoder().decode(CERT_BASE64_STRING);
		try {
