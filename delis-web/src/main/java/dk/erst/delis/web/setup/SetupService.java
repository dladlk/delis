...
public class SetupService {
    ...
    public List<ConfigValueData> createConfigValuesList (ConfigBean configBean) {
        ...
        configValueData.add(new ConfigValueData("Root Storage for Documents", "config.storageDocumentRoot",configBean.getStorageLoadedPath(), ConfigValueType.STORAGE_DOCUMENT_ROOT.name()));
