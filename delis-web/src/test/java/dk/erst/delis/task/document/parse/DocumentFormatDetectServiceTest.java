...
public class DocumentFormatDetectServiceTest {
	...
	public void testDefineDocumentFormat() {
		...
		assertEquals(DocumentFormat.BIS3_CATALOGUE_WITHOUT_RESP, s.defineDocumentFormat(tc("Catalogue", "urn:oasis:names:specification:ubl:schema:xsd:Catalogue-2", DocumentFormatConst.CUSTOMIZATION_BIS3_CATALOGUE_STARTS_WITH, DocumentFormatConst.PROFILE_BIS3_CATALOGUE_WITHOUT_RESPONSE)));
